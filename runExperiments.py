...
for scenario in range(1,4):
    ...
    for planner in planners:
        ...
        for iteration in range(3):
            ...
            cmd += " -planner 1 -max_iters {} -d_crit {} -delta_q 3.1415 -epsilon_q 0.05 -num_spikes 2 -p_close_enough {} ".format(rrtSize, dcrit, distanceToGoal)
            cmd += " -prob_steer 0.1 -target_prefix {} -render 0 -vis_script scripts/animate_scene.py -cx -1 -cy 3 -cz 6 -groundLevel 0.00 -minColSegIdx 6 ".format(outFile)
